...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $insertSQL = sprintf("INSERT INTO tbl_productos_tabs (nombre, code, producto) VALUES (%s, %s, %s)",
  ...
  $insertGoTo = "catalogo_tabs.php?id=".$_GET['id'];
  if (isset($_SERorden['QUERY_STRING'])) {
...
mysql_select_db($database_admin, $admin);
$query_ver = "SELECT * FROM tbl_productos_tabs WHERE producto = '".$_GET['id']."' ORDER BY id ASC";
					...
					<header class="page-header">
						...
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Nuevo Tab</h2>
							</header>
							...
							<div class="panel-body">
								...
								<div>
											...
											<div class="form-group">
												<label class="col-md-3 control-label" for="inputDefault">Nombre Tab</label>
												<div class="col-md-6">
							...
							<header class="panel-heading">
								...
								<h2 class="panel-title">Listado de Tabs</h2>
							</header>
							<div class="panel-body">
											...
											<table class="table table-bordered mb-none">
                                                ...
                                                <?php do{ ?>
													<tr>
														...
														<td>
                                                        <a href="catalogo_tabs_editar.php?id=<?php echo $_GET['id']; ?>&editar=<?php echo $row_ver['id']; ?>" class="mb-xs mt-xs mr-xs btn btn-sm btn-success"><i class="fa fa-pencil"></i> Editar</a> 
                                                            ...
                                                            <footer class="panel-footer">
                                                                <div class="row">
                                                                    <div class="col-md-12 text-right">
                                                                        <a class="btn btn-primary modal-confirm" href="catalogo_tabs_eliminar.php?id=<?php echo $_GET['id']; ?>&eliminar=<?php echo $row_ver['id']; ?>">Confirmar</a>
