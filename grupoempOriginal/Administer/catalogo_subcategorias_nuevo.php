...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $insertGoTo = "catalogo_subcategorias.php";
  if (isset($_SERorden['QUERY_STRING'])) {
					...
					<header class="page-header">
						...
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Nueva Subcategoria</h2>
							</header>
							...
							<div class="panel-body">
								...
								<div>
											...
											<div class="form-group">
												<label class="col-md-3 control-label" for="inputDefault">Nombre Subcategoria</label>
												<div class="col-md-6">
