...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
	...
	if($_FILES['ima']['name']==""){
		...
		$varimagen = "USER-".$codigounico.$_FILES['ima']['name'];
		}
				
  $updateSQL = sprintf("UPDATE tbl_indice SET titulo=%s, direccion=%s, telefono=%s, celular=%s, correo=%s, web=%s, ciudad=%s, imagen=%s, contenido=%s, fabricante=%s, representante=%s, dis_exclusivo=%s, dis_mayorista=%s WHERE id=%s",
  ...
  if($_FILES['ima']['name']!= ""){
		copy($_FILES['ima']['tmp_name'],"../public/USER-".$codigounico.$_FILES['ima']['name']); 
		 $dim = getimagesize("../public/USER-".$codigounico.$_FILES['ima']['name']);
		 
		 if($dim[0]>=300){
				
				
  						$thumb1=new thumbnail("../public/USER-".$codigounico.$_FILES['ima']['name']); 
					    $thumb1->size_width(300);
					    $thumb1->jpeg_quality(90);
					    $thumb1->save("../public/USER-".$codigounico.$_FILES['ima']['name']);
...
mysql_select_db($database_admin, $admin);
$query_editar = "SELECT * FROM tbl_indice WHERE id = '".$_GET['id']."' ORDER BY id DESC";
							...
							<div class="panel-body">
								...
								<div>
											...
											<div class="form-group">
												...
												<div class="col-md-7">
													<input name="direccion" type="text" class="form-control" id="direccion" value="<?php echo $row_editar['direccion']; ?>" >
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-md-7">
													<input name="telefono" type="text" class="form-control" id="telefono" value="<?php echo $row_editar['telefono']; ?>" >
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-md-7">
													<input name="celular" type="text" class="form-control" id="celular" value="<?php echo $row_editar['celular']; ?>" >
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-md-7">
													<input name="correo" type="text" class="form-control" id="correo" value="<?php echo $row_editar['correo']; ?>" >
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-md-7">
													<input name="web" type="text" class="form-control" id="web" value="<?php echo $row_editar['web']; ?>" >
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-md-7">
													<input name="ciudad" type="text" class="form-control" id="ciudad" value="<?php echo $row_editar['ciudad']; ?>" >
												</div>
											</div>			
											...
											<div class="form-group">
												...
												<div class="col-md-7">
													<div class="checkbox-custom checkbox-primary">
														<input <?php if ($row_editar['fabricante']=="1") { echo "checked"; } ?> type="checkbox" value="1" name="fabricante" id="fabricante">
														<label for="fabricante">Fabricante</label>
													</div>

													<div class="checkbox-custom checkbox-primary">
														<input <?php if ($row_editar['representante']=="1") { echo "checked"; } ?> type="checkbox" value="1" name="representante" id="representante">
														<label for="representante">Representante</label>
													</div>

													<div class="checkbox-custom checkbox-primary">
														<input <?php if ($row_editar['dis_exclusivo']=="1") { echo "checked"; } ?> type="checkbox" value="1" name="dis_exclusivo" id="dis_exclusivo">
														<label for="dis_exclusivo">Distribuidor Exclusivo</label>
													</div>

													<div class="checkbox-custom checkbox-primary">
														<input <?php if ($row_editar['dis_mayorista']=="1") { echo "checked"; } ?> type="checkbox" value="1" name="dis_mayorista" id="dis_mayorista">
											...
											<div class="form-group">
												<div class="col-sm-10 col-sm-offset-1">
													<textarea name="contenido" id="contenido"><?php echo $row_editar['contenido']; ?></textarea>
													<script type="text/javascript">
