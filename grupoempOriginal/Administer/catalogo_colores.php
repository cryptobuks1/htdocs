...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $insertSQL = sprintf("INSERT INTO tbl_productos_color (color, imagen, pdt) VALUES (%s, %s, %s)",
                       GetSQLValueString($_POST['nombre'], "text"),
                       GetSQLValueString($varimagen, "text"),
					   GetSQLValueString($_GET['id'], "text"));

  if($_FILES['imagen']['name']!= ""){
		copy($_FILES['imagen']['tmp_name'],"../public/COLOR-".$codigounico.$_FILES['imagen']['name']); 
		/*
  ...
  $insertGoTo = "catalogo_colores.php?id=".$_GET['id'];
  if (isset($_SERorden['QUERY_STRING'])) {
...
mysql_select_db($database_admin, $admin);
$query_ver = "SELECT * FROM tbl_productos_color WHERE pdt = '".$_GET['id']."' ORDER BY id ASC";
			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
					<header class="page-header">
						<h2>Catalogo - Productos - Colores</h2>
						...
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Nuevo Color</h2>
							</header>
							...
							<div class="panel-body">
								...
								<div>
											...
											<div class="form-group">
												<label class="col-md-3 control-label" for="inputDefault">Nombre Color</label>
												<div class="col-md-6">
													<input name="nombre" type="text" class="form-control" id="nombre" title="Ingresa el nombre del color."  required  onkeyup="fAgrega();">
												</div>
											</div>
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-6">
                                                    ...
                                                    <span class="help-block">Se recomienda subir fotos en buena calidad.</span>
												</div>
											</div>
											...
											<table class="table table-bordered mb-none">
                                                ...
                                                <?php do{ ?>
													<tr>
														...
														<td><?php echo $row_ver['color']; ?></td>
														<td><img width="150" src="../public/<?php echo $row_ver['imagen']; ?>"></td>
														<td>
                                                            ...
                                                            <footer class="panel-footer">
                                                                <div class="row">
                                                                    <div class="col-md-12 text-right">
                                                                        <a class="btn btn-primary modal-confirm" href="catalogo_colores_eliminar.php?id=<?php echo $_GET['id']; ?>&eliminar=<?php echo $row_ver['id']; ?>">Confirmar</a>
