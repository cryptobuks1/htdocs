...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $insertSQL = sprintf("INSERT INTO tbl_banner (titulo, code, contenido) VALUES (%s, %s, %s)",
					...
					<header class="page-header">
						...
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Slider Nuevo</h2>
							</header>
							...
							<div class="panel-body">
								...
								<div>
											...
											<div class="form-group">
												...
												<div class="col-md-6">
													<input name="titulo" type="text" class="form-control" id="titulo" title="Ingresa el titulo del slider."  required  onkeyup="fAgrega();">
                                                    <input name="seo" type="hidden" class="form-control" id="seo" title="Ingresa un contenido SEO URL." >
												</div>
											</div>
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-6">
													<input name="contenido" type="text" class="form-control" id="contenido" title="Ingresa el tamaño del slider."  required  onkeyup="fAgrega();">
												</div>
											</div>
