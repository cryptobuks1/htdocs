...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $insertSQL = sprintf("INSERT INTO tbl_publicaciones (titulo, code, contenido, imagen, orden, estado, categoria, embed) VALUES (%s, %s, %s, %s, %s, %s, %s, %s)",
					...
					<header class="page-header">
						...
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Nueva Publicación</h2>
							</header>
