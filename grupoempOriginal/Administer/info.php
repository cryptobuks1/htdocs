...
$query_ver = "SELECT * FROM tbl_info ORDER BY id ASC";
					...
					<header class="page-header">
						...
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Listado de Secciones</h2>
							</header>
							<div class="panel-body">
                            	<div style="margin-bottom:10px;">
									<a href="info_nuevo.php" class="mb-xs mt-xs mr-xs btn btn-default">Nueva Sección</a>
								</div>
								<div >
											<table class="table table-bordered table-striped mb-none" id="datatable-default">
                                                ...
                                                <?php do{ ?>
													<tr>
														...
														<td>/info/<?php echo $row_ver['code']; ?>/</td>
														<td>
                                                        <a href="info_editar.php?id=<?php echo $row_ver['id']; ?>" class="mb-xs mt-xs mr-xs btn btn-sm btn-success"><i class="fa fa-pencil"></i> Editar</a> 
                                                            ...
                                                            <footer class="panel-footer">
                                                                <div class="row">
                                                                    <div class="col-md-12 text-right">
                                                                        <a class="btn btn-primary modal-confirm" href="info_eliminar.php?id=<?php echo $row_ver['id']; ?>">Confirmar</a>
