...
$query_ver = "SELECT * FROM tbl_indice ORDER BY id DESC";
						...
						<section class="panel">
							...
							<div class="panel-body">
                            	<div style="margin-bottom:10px;">
									<a href="indice_nuevo.php" class="mb-xs mt-xs mr-xs btn btn-default">Nueva Entrada</a>
								</div>
								<div >
											<table class="table table-bordered table-striped mb-none" id="datatable-default">
                                                ...
                                                <?php do{ ?>
													<tr>
														...
														<td>
                                                        <a href="indice_editar.php?id=<?php echo $row_ver['id']; ?>" class="mb-xs mt-xs mr-xs btn btn-sm btn-success"><i class="fa fa-pencil"></i> Editar</a>
                                                            ...
                                                            <footer class="panel-footer">
                                                                <div class="row">
                                                                    <div class="col-md-12 text-right">
                                                                        <a class="btn btn-primary modal-confirm" href="indice_eliminar.php?id=<?php echo $row_ver['id']; ?>">Confirmar</a>
