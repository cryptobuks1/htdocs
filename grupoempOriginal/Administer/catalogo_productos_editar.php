...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
	...
	if($_FILES['ima']['name']==""){
		...
		$varimagen = "PROD-".$codigounico.$_FILES['ima']['name'];
		}
				
  $updateSQL = sprintf("UPDATE tbl_productos SET nombre=%s, code=%s, precio=%s, des=%s, especificaciones=%s, imagen=%s, estado=%s, categoria=%s, destacado=%s WHERE id=%s",
  ...
  if($_FILES['ima']['name']!= ""){
		copy($_FILES['ima']['tmp_name'],"../public/PROD-".$codigounico.$_FILES['ima']['name']); 
		/*
		 $dim = getimagesize("../public/PROD-".$codigounico.$_FILES['ima']['name']);
		 
		 if($dim[0]>=500){
				
				
  						$thumb1=new thumbnail("../public/PROD-".$codigounico.$_FILES['ima']['name']); 
					    $thumb1->size_width(500);
					    $thumb1->jpeg_quality(90);
					    $thumb1->save("../public/PROD-".$codigounico.$_FILES['ima']['name']);
...
mysql_select_db($database_admin, $admin);
$query_editar = sprintf("SELECT * FROM tbl_productos WHERE id = %s", GetSQLValueString($colname_editar, "int"));
							...
							<div class="panel-body">
								...
								<div>
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-6">
													<select class="form-control mb-md" name="categoria">
                                                    	<?php do{ ?>
														<option value="<?php echo $row_ver['id']; ?>" <?php if($row_editar['categoria']==$row_ver['id']){ echo "selected"; } ?>><?php echo $row_ver['nombre']; ?></option>
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-6">
													<input name="precio" type="text" class="form-control" id="precio" value="<?php echo $row_editar['precio']; ?>">
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-md-9">
													<textarea name="especificaciones" class="form-control" id="especificaciones" ><?php echo $row_editar['especificaciones']; ?></textarea>
											...
											<div class="form-group">
												...
												<div class="col-md-6">
													<select class="form-control mb-md" name="destacado">
														<option value="1" <?php if($row_editar['destacado']=="1"){ echo "selected"; } ?> >Si</option>
														<option value="0" <?php if($row_editar['destacado']=="0"){ echo "selected"; } ?> >No</option>
