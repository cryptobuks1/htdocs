...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  ...
  $updateSQL = sprintf("UPDATE menu2 SET titulo=%s,  link=%s, target=%s, imagen=%s, estado=%s  WHERE id=%s",
  ...
  if($_FILES['ima']['name']!=""){ copy ($_FILES['ima']['tmp_name'],"../img/menu/SLIDE-".$codigounico.$_FILES['ima']['name']); }

  mysql_select_db($database_admin, $admin);
  $Result1 = mysql_query($updateSQL, $admin) or die(mysql_error());

  $updateGoTo = "menu2.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_admin, $admin);
$query_editar = sprintf("SELECT * FROM menu2 WHERE id = %s", GetSQLValueString($colname_editar, "int"));
					...
					<header class="page-header">
						...
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Editar botón - <?php echo $row_tipo['titulo'] ?> <?php echo $row_tipo['contenido'] ?></h2>
							</header>
							...
							<div class="panel-body">
                            	<div style="margin-bottom:10px;">
									<a href="menu.php?tipo=<?php echo $_GET['tipo']; ?>" class="mb-xs mt-xs mr-xs btn btn-default"><li class="fa fa-arrow-circle-o-left"></li> Regresar</a>
								...
								<div>
                                            ...
                                            <div class="form-group">
												...
												<div class="img-thumbnail">
														...
														<a><img src="../img/menu/<?php echo $row_editar['imagen']; ?>" alt="" width="300"></a>
