...
$query_ver = "SELECT * FROM tbl_publicaciones_top WHERE estado = '1' AND categoria = '2' ORDER BY orden ASC";
...
<html class="fixed">
					...
					<header class="page-header">
						...
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Definir Orden de Pistas</h2>
							</header>
	...
	$(document).ready(function(){
		$("ul#ordenar").sortable({ placeholder: "ui-state-highlight",opacity: 0.6, cursor: 'move', update: function() {
			...
			$.post("top_order.php", order, function(respuesta){
