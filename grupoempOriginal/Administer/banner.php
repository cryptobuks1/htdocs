...
$query_ver = "SELECT * FROM banner WHERE tipo = '".$_GET['tipo']."' ORDER BY orden ASC";
					...
					<header class="page-header">
						...
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Listado de Banners - <?php echo $row_tipo['titulo'] ?> <?php echo $row_tipo['contenido'] ?></h2>
							</header>
							<div class="panel-body">
                            	<div style="margin-bottom:10px;">
                                	<a href="banner_list.php" class="mb-xs mt-xs mr-xs btn btn-default">Regresar</a>
									<a href="banner_nuevo.php?tipo=<?php echo $_GET['tipo']; ?>" class="mb-xs mt-xs mr-xs btn btn-default">Nuevo Banner</a>
									<a href="banner_orden.php?tipo=<?php echo $_GET['tipo']; ?>" class="mb-xs mt-xs mr-xs btn btn-default">Definir Orden de Banners</a>
								</div>
											...
											<table class="table table-bordered mb-none">
                                                ...
                                                <?php do{ ?>
													<tr>
														...
														<td>
                                                        <a href="banner_editar.php?id=<?php echo $row_ver['id']; ?>&tipo=<?php echo $_GET['tipo']; ?>" class="mb-xs mt-xs mr-xs btn btn-sm btn-success"><i class="fa fa-pencil"></i> Editar</a>
