...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
		...
		$varimagen = "ALBUM-".$codigounico.$_FILES['imagen']['name'];
		
		mysql_select_db($database_admin, $admin);
		$query_orden = "SELECT * FROM tbl_album ORDER BY id DESC";
  ...
  $insertSQL = sprintf("INSERT INTO tbl_album (titulo, code, contenido, imagen, orden, estado, categoria, vincular) VALUES (%s, %s, %s, %s, %s, %s, %s, %s)",
	...
	if($_FILES['imagen']['name']!= ""){
		copy($_FILES['imagen']['tmp_name'],"../public/ALBUM-".$codigounico.$_FILES['imagen']['name']); 
		 $dim = getimagesize("../public/ALBUM-".$codigounico.$_FILES['imagen']['name']);
		 
		 if($dim[0]>=500){
				
				
  						$thumb1=new thumbnail("../public/ALBUM-".$codigounico.$_FILES['imagen']['name']); 
					    $thumb1->size_width(500);
					    $thumb1->jpeg_quality(90);
					    $thumb1->save("../public/ALBUM-".$codigounico.$_FILES['imagen']['name']);
					...
					<header class="page-header">
						...
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Nuevo Album</h2>
							</header>
