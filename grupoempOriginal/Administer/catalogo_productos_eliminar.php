...
if ((isset($_GET['id'])) && ($_GET['id'] != "")) {
	...
	$query_filedel = "SELECT * FROM tbl_productos WHERE id = '".$_GET['id']."' ORDER BY id DESC";
  ...
  $deleteSQL = sprintf("DELETE FROM tbl_productos WHERE id=%s",
                       GetSQLValueString($_GET['id'], "int"));

  mysql_select_db($database_admin, $admin);
  $Result1 = mysql_query($deleteSQL, $admin) or die(mysql_error());

  $deleteGoTo = "catalogo_productos.php";
