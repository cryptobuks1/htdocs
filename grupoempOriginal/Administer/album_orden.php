...
$query_ver = "SELECT * FROM tbl_album WHERE estado = '1' AND categoria = '2' ORDER BY orden ASC";
...
<html class="fixed">
					...
					<header class="page-header">
						...
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Definir Orden de Albumes</h2>
							</header>
										...
										<li id="registro-<?php echo $row_ver['id'] ?>">
											<div class="post-image">
												<div class="img-thumbnail">
														...
														<a><img src="../public/<?php echo $row_ver['imagen']; ?>" alt="" width="100"></a>
	...
	$(document).ready(function(){
		$("ul#ordenar").sortable({ placeholder: "ui-state-highlight",opacity: 0.6, cursor: 'move', update: function() {
			...
			$.post("album_order.php", order, function(respuesta){
