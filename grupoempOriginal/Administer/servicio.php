...
$query_ver = "SELECT * FROM servicio ORDER BY id ASC";
$ver = mysql_query($query_ver, $admin) or die(mysql_error());
$row_ver = mysql_fetch_assoc($ver);
$totalRows_ver = mysql_num_rows($ver);

mysql_select_db($database_admin, $admin);
$query_categorias = "SELECT * FROM categoria  where id = '$row_ver[categoria]' ORDER BY id ASC";
					...
					<header class="page-header">
						...
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Listado de Sevicios</h2>
							</header>
							<div class="panel-body">
                            	<div style="margin-bottom:10px;">
									<a href="servicio_nuevo.php" class="mb-xs mt-xs mr-xs btn btn-default">Nuevo servicio</a>
								</div>
								<div >
											<table class="table table-bordered table-striped mb-none" id="datatable-default">
                                                ...
                                                <?php do{ ?>
													<tr>
														...
														<td><?php echo $row_ver['fecha']; ?></td>
														<td><?php echo $row_ver['estado']; ?></td>
														<td>
                                                        <a href="servicio_editar.php?id=<?php echo $row_ver['id']; ?>" class="mb-xs mt-xs mr-xs btn btn-sm btn-success"><i class="fa fa-pencil"></i> Editar</a> 
                                                            ...
                                                            <footer class="panel-footer">
                                                                <div class="row">
                                                                    <div class="col-md-12 text-right">
                                                                        <a class="btn btn-primary modal-confirm" href="servicio_eliminar.php?id=<?php echo $row_ver['id']; ?>">Confirmar</a>
