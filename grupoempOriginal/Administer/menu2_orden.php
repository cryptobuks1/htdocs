...
$query_ver = "SELECT * FROM menu2 WHERE estado = '1' AND tipo = '".$_GET['tipo']."' ORDER BY orden ASC";
...
<html class="fixed">
					...
					<header class="page-header">
						...
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Definir Orden del menú 2 - <?php echo $row_tipo['titulo'] ?> <?php echo $row_tipo['contenido'] ?></h2>
							</header>
							<div class="panel-body">
                            	<div style="margin-bottom:10px;">
									<a href="menu2.php?tipo=<?php echo $_GET['tipo']; ?>" class="mb-xs mt-xs mr-xs btn btn-default"><li class="fa fa-arrow-circle-o-left"></li> Regresar</a>
								</div>
										...
										<li id="registro-<?php echo $row_ver['id'] ?>">
											<div class="post-image">
												<div class="img-thumbnail">
														...
														<a><img src="../img/menu/<?php echo $row_ver['imagen']; ?>" alt="" width="150"></a>
													
												</div>
											</div>
											<div class="post-info">
												<?php echo $row_ver['titulo']; ?>
	...
	$(document).ready(function(){
		$("ul#ordenar").sortable({ placeholder: "ui-state-highlight",opacity: 0.6, cursor: 'move', update: function() {
			...
			$.post("menu2_order.php", order, function(respuesta){
