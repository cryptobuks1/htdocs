...
$query_ver = "SELECT * FROM tbl_planes ORDER BY id ASC";
											...
											<table class="table table-bordered mb-none">
                                                ...
                                                <?php do{ ?>
													<tr>
														...
														<td>
                                                        <a class="mb-xs mt-xs mr-xs btn btn-sm btn-info" href="planes.php?tipo=<?php echo $row_ver['id']; ?>"><i class="fa fa-file-image-o"></i> Ingresar Imagenes</a>
