					...
					<div id="userbox" class="userbox">
						...
						<div class="dropdown-menu">
							<ul class="list-unstyled">
								<li class="divider"></li>
								<li>
									<a role="menuitem" tabindex="-1" href="admin.php" data-lock-screen="true"><i class="fa fa-lock"></i> Datos de Acceso</a>
								</li>
								<li>
									<a role="menuitem" tabindex="-1" href="salir.php"><i class="fa fa-power-off"></i> Cerrar Sesión</a>
								</li>
							</ul>
						</div>
					</div>
