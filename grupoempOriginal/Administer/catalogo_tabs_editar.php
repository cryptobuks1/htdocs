...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE tbl_productos_tabs SET nombre=%s, code=%s, contenido=%s WHERE id=%s",
...
if (isset($_GET['editar'])) {
  $colname_ver = $_GET['editar'];
}
mysql_select_db($database_admin, $admin);
$query_ver = sprintf("SELECT * FROM tbl_productos_tabs WHERE id = %s", GetSQLValueString($colname_ver, "int"));
					...
					<header class="page-header">
						...
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Editar Tab</h2>
							</header>
							...
							<div class="panel-body">
                            	<div style="margin-bottom:10px;">
									<a href="catalogo_tabs.php?id=<?php echo $_GET['id']; ?>" class="mb-xs mt-xs mr-xs btn btn-default"><li class="fa fa-arrow-circle-o-left"></li> Regresar</a>
								...
								<div>
											...
											<div class="form-group">
												...
												<div class="col-md-9">
													...
													<textarea class="input-block-level" name="contenido" id="contenido" rows="18">
