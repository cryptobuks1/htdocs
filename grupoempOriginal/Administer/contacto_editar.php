...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  ...
  $updateSQL = sprintf("UPDATE tbl_contacto SET  imagen=%s WHERE id=%s",
  ...
  if($_FILES['ima']['name']!= ""){
		...
		copy($_FILES['ima']['tmp_name'],"../images/ALBUM-".$codigounico.$_FILES['ima']['name']); 

		 $dim = getimagesize("../images/ALBUM-".$codigounico.$_FILES['ima']['name']);
		 ...
		 if($dim[0]>=500){
  						...
  						$thumb1=new thumbnail("../images/ALBUM-".$codigounico.$_FILES['ima']['name']); 

					    $thumb1->size_width(500);

					    $thumb1->jpeg_quality(90);

					    $thumb1->save("../images/ALBUM-".$codigounico.$_FILES['ima']['name']);
...
mysql_select_db($database_admin, $admin);
$query_contacto = "SELECT * FROM tbl_contacto ORDER BY id ASC";
$contacto = mysql_query($query_contacto, $admin) or die(mysql_error());
					...
					<header class="page-header">
						...
						<section class="panel">
							...
							<header class="panel-heading">
								...
								<h2 class="panel-title">Editar contacto</h2>
								...
								<div>
                                            ...
                                            <div class="form-group">
												...
												<div class="img-thumbnail">
														...
														<a><img src="../images/<?php echo $row_contacto['imagen']; ?>" alt="" width="300"></a>
							...
							<input type="hidden" name="id" value="<?php echo $row_contacto['id']; ?>" />

                            <input name="imagen" type="hidden" id="imagen" value="<?php echo $row_contacto['imagen']; ?>" />
