...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE tbl_menu2 SET titulo=%s, code=%s, contenido=%s WHERE id=%s",
...
mysql_select_db($database_admin, $admin);
$query_ver = sprintf("SELECT * FROM tbl_menu2 WHERE id = %s", GetSQLValueString($colname_ver, "int"));
