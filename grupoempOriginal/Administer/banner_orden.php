...
$query_ver = "SELECT * FROM banner WHERE estado = '1' AND tipo = '".$_GET['tipo']."' ORDER BY orden ASC";
...
<html class="fixed">
					...
					<header class="page-header">
						...
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Definir Orden de Banners - <?php echo $row_tipo['titulo'] ?> <?php echo $row_tipo['contenido'] ?></h2>
							</header>
										...
										<li id="registro-<?php echo $row_ver['id'] ?>">
											<div class="post-image">
												<div class="img-thumbnail">
														...
														<a><img src="../img/banner/<?php echo $row_ver['imagen']; ?>" alt="" width="150"></a>
	...
	$(document).ready(function(){
		$("ul#ordenar").sortable({ placeholder: "ui-state-highlight",opacity: 0.6, cursor: 'move', update: function() {
			...
			$.post("banner_order.php", order, function(respuesta){
