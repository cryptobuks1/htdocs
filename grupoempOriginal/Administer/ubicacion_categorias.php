...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $insertSQL = sprintf("INSERT INTO tbl_ubicaciones_categorias (nombre, code) VALUES (%s, %s)",
  ...
  $insertGoTo = "ubicacion_categorias.php";
  if (isset($_SERorden['QUERY_STRING'])) {
...
mysql_select_db($database_admin, $admin);
$query_ver = "SELECT * FROM tbl_ubicaciones_categorias ORDER BY id ASC";
											...
											<table class="table table-bordered mb-none">
                                                ...
                                                <?php do{ ?>
													<tr>
														...
														<td>
                                                        <a href="ubicacion_categoriaeditar.php?id=<?php echo $row_ver['id']; ?>" class="mb-xs mt-xs mr-xs btn btn-sm btn-success"><i class="fa fa-pencil"></i> Editar</a> 
                                                            ...
                                                            <footer class="panel-footer">
                                                                <div class="row">
                                                                    <div class="col-md-12 text-right">
                                                                        <a class="btn btn-primary modal-confirm" href="ubicacion_categoriaeliminar.php?id=<?php echo $row_ver['id']; ?>">Confirmar</a>
