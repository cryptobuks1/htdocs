...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE tbl_publicaciones_categorias SET nombre=%s, code=%s WHERE id=%s",
  ...
  $updateGoTo = "publicacion_categorias.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_admin, $admin);
$query_ver = sprintf("SELECT * FROM tbl_publicaciones_categorias WHERE id = %s", GetSQLValueString($colname_ver, "int"));
						...
						<section class="panel">
							...
							<div class="panel-body">
                            	<div style="margin-bottom:10px;">
									<a href="publicacion_categorias.php" class="mb-xs mt-xs mr-xs btn btn-default"><li class="fa fa-arrow-circle-o-left"></li> Regresar</a>
