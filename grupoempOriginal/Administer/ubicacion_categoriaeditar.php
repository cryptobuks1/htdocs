...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE tbl_ubicaciones_categorias SET nombre=%s, code=%s WHERE id=%s",
  ...
  $updateGoTo = "ubicacion_categorias.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_admin, $admin);
$query_ver = sprintf("SELECT * FROM tbl_ubicaciones_categorias WHERE id = %s", GetSQLValueString($colname_ver, "int"));
