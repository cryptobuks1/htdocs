...
$query_ver = "SELECT * FROM tbl_publicaciones_top WHERE categoria = '2' ORDER BY orden ASC";
						...
						<section class="panel">
							...
							<div class="panel-body">
                            	<div style="margin-bottom:10px;">
									<a href="pistas_nuevo.php" class="mb-xs mt-xs mr-xs btn btn-default">Nueva Pista</a>
									<a href="pistas_orden.php" class="mb-xs mt-xs mr-xs btn btn-default">Definir Orden de Pistas</a>
								</div>
								<div >
											<table class="table table-bordered table-striped mb-none" id="datatable-default">
                                                ...
                                                <?php do{ ?>
													<tr>
                                                        ...
                                                        <a href="pistas_editar.php?id=<?php echo $row_ver['id']; ?>" class="mb-xs mt-xs mr-xs btn btn-sm btn-success"><i class="fa fa-pencil"></i> Editar</a>
                                                            ...
                                                            <footer class="panel-footer">
                                                                <div class="row">
                                                                    <div class="col-md-12 text-right">
                                                                        <a class="btn btn-primary modal-confirm" href="pistas_eliminar.php?id=<?php echo $row_ver['id']; ?>">Confirmar</a>
