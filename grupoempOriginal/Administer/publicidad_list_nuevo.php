...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $insertSQL = sprintf("INSERT INTO tbl_publicidades (titulo, tipo, codigo) VALUES (%s, %s, %s)",
  ...
  $insertGoTo = "publicidad_list.php";
  if (isset($_SERorden['QUERY_STRING'])) {
							...
							<div class="panel-body">
								...
								<div>
											...
											<div class="form-group">
												...
												<div class="col-md-6">
													<input name="titulo" type="text" class="form-control" id="titulo" title="Ingresa el titulo del Espacio."  required  onkeyup="fAgrega();">
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-6">
													<select class="form-control " name="tipo" id="tipo">
														...
														<option value="2">Adsense (Publicidad Google)</option>
