...
$query_ver = "SELECT * FROM tbl_ubicaciones ORDER BY nombre ASC";
					...
					<header class="page-header">
						...
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Listado de Ubicaciones</h2>
							</header>
							<div class="panel-body">
                            	<div style="margin-bottom:10px;">
									<a href="ubicacion_nuevo.php" class="mb-xs mt-xs mr-xs btn btn-default">Nueva Ubicacion</a>
                                     <a href="ubicacion_categorias.php" class="mb-xs mt-xs mr-xs btn btn-default">Categorias</a>
								</div>
								<div >
											<table class="table table-bordered table-striped mb-none" id="datatable-default">
                                                ...
                                                <?php do{ 
                                                mysql_select_db($database_admin, $admin);
												$query_vercat = "SELECT * FROM tbl_ubicaciones_categorias WHERE id = '".$row_ver['categoria']."' ORDER BY id DESC";
												...
												$totalRows_vercat = mysql_num_rows($vercat);?>
													<tr>
                                                        ...
                                                        <a href="ubicacion_editar.php?id=<?php echo $row_ver['id']; ?>" class="mb-xs mt-xs mr-xs btn btn-sm btn-success"><i class="fa fa-pencil"></i> Editar</a>
                                                            ...
                                                            <footer class="panel-footer">
                                                                <div class="row">
                                                                    <div class="col-md-12 text-right">
                                                                        <a class="btn btn-primary modal-confirm" href="ubicacion_eliminar.php?id=<?php echo $row_ver['id']; ?>">Confirmar</a>
