...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  ...
  $updateSQL = sprintf("UPDATE tbl_publicaciones SET titulo=%s, code=%s, contenido=%s, imagen=%s, estado=%s, categoria=%s, embed=%s WHERE id=%s",
...
mysql_select_db($database_admin, $admin);
$query_editar = sprintf("SELECT * FROM tbl_publicaciones WHERE id = %s", GetSQLValueString($colname_editar, "int"));
...
mysql_select_db($database_admin, $admin);
$query_categorias = "SELECT * FROM tbl_publicaciones_categorias ORDER BY nombre ASC";
					...
					<header class="page-header">
						...
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Editar Publicación</h2>
							</header>
							...
							<div class="panel-body">
                            	<div style="margin-bottom:10px;">
									<a href="publicacion.php" class="mb-xs mt-xs mr-xs btn btn-default"><li class="fa fa-arrow-circle-o-left"></li> Regresar</a>
								...
								<div>
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-6">
													...
													<span class="help-block">Para las publicaciones usar la plataforma <a href="http://issuu.com/" target="_blank">Issuu</a>.
												<br>
												Siempre conservar los siguientes parametros: <br>
												<strong>width:100%; height:695px;</strong> 
												</span>
												</div>
											</div>
