...
$query_ver = "SELECT * FROM tbl_staff ORDER BY orden ASC";
					...
					<header class="page-header">
						...
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Listado de Personas</h2>
							</header>
							<div class="panel-body">
                            	<div style="margin-bottom:10px;">
									<a href="staff_nuevo.php" class="mb-xs mt-xs mr-xs btn btn-default">Nueva Persona</a>
                                    <a href="staff_orden.php" class="mb-xs mt-xs mr-xs btn btn-default">Definir Orden de Personas</a>
								</div>
								<div >
											<table class="table table-bordered table-striped mb-none" id="datatable-default">
                                                ...
                                                <?php do{ ?>
													<tr>
                                                        ...
                                                        <a href="staff_editar.php?id=<?php echo $row_ver['id']; ?>" class="mb-xs mt-xs mr-xs btn btn-sm btn-success"><i class="fa fa-pencil"></i> Editar</a>
                                                            ...
                                                            <footer class="panel-footer">
                                                                <div class="row">
                                                                    <div class="col-md-12 text-right">
                                                                        <a class="btn btn-primary modal-confirm" href="staff_eliminar.php?id=<?php echo $row_ver['id']; ?>">Confirmar</a>
