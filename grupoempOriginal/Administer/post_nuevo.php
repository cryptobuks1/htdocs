...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
		...
		$varimagen = "POST-".$codigounico.$_FILES['imagen']['name'];
		
		
		
  $insertSQL = sprintf("INSERT INTO tbl_post (autor, titulo, code, descripcion, detalle, embed, fecha, estado, galeria, imagen) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
	...
	if($_FILES['imagen']['name']!= ""){
		copy($_FILES['imagen']['tmp_name'],"../public/POST-".$codigounico.$_FILES['imagen']['name']); 
		 $dim = getimagesize("../public/POST-".$codigounico.$_FILES['imagen']['name']);
		 
		 if($dim[0]>=500){
				
				
  						$thumb1=new thumbnail("../public/POST-".$codigounico.$_FILES['imagen']['name']); 
					    $thumb1->size_width(500);
					    $thumb1->jpeg_quality(90);
					    $thumb1->save("../public/POST-".$codigounico.$_FILES['imagen']['name']);
  ...
  mysql_select_db($database_admin, $admin);
	$query_ultimo = "SELECT * FROM tbl_post ORDER BY id DESC";
	$ultimo = mysql_query($query_ultimo, $admin) or die(mysql_error());
   ...
   $categorias = $_POST['categorias'];
		  foreach($categorias AS $key=>$values)
		  {
		  	 ...
		  	 $insertSQL = sprintf("INSERT INTO tbl_post_relacion (post, categoria) VALUES (%s, %s)",
					   GetSQLValueString($row_ultimo['id'], "text"),
							...
							<div class="panel-body">
								...
								<div>
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-9">
													<input name="autor" type="text" class="form-control" id="autor" title="Ingresa el autor de la entrada."  required>
												</div>
											</div>
											<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="col-md-9">
													<textarea name="descripcion" class="form-control" rows="3" id="descripcion" data-plugin-textarea-autosize="" style="oordenflow: hidden; word-wrap: break-word; resize: none; height: 74px;" required title="Ingresa una breve descripcion para la entrada." data-plugin-maxlength maxlength="300"></textarea>
												</div>
											</div>
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-6">
													<div class="input-group">
														...
														<input type="text" name="fecha" data-plugin-datepicker="" class="form-control" required title="Debes ingresar una fecha para la entrada." value="<?php echo date("Y-m-d"); ?>">
													</div>
												</div>
											</div>
