...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  ...
  $updateSQL = sprintf("UPDATE banner SET titulo=%s,  link=%s, imagen=%s, estado=%s  WHERE id=%s",
  ...
  if($_FILES['ima']['name']!=""){ copy ($_FILES['ima']['tmp_name'],"../img/banner/SLIDE-".$codigounico.$_FILES['ima']['name']); }
...
mysql_select_db($database_admin, $admin);
$query_editar = sprintf("SELECT * FROM banner WHERE id = %s", GetSQLValueString($colname_editar, "int"));
					...
					<header class="page-header">
						...
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Editar Banner - <?php echo $row_tipo['titulo'] ?> <?php echo $row_tipo['contenido'] ?></h2>
							</header>
								...
								<div>
                                            ...
                                            <div class="form-group">
												...
												<div class="img-thumbnail">
														...
														<a><img src="../img/banner/<?php echo $row_editar['imagen']; ?>" alt="" width="300"></a>
