...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
		...
		$varimagen = "STAFF-".$codigounico.$_FILES['imagen']['name'];
		
		mysql_select_db($database_admin, $admin);
		$query_orden = "SELECT * FROM tbl_staff ORDER BY id DESC";
  ...
  $insertSQL = sprintf("INSERT INTO tbl_staff (titulo, code, contenido, imagen, orden, estado, embed) VALUES (%s, %s, %s, %s, %s, %s, %s)",
	...
	if($_FILES['imagen']['name']!= ""){
		copy($_FILES['imagen']['tmp_name'],"../public/STAFF-".$codigounico.$_FILES['imagen']['name']); 
		 $dim = getimagesize("../public/STAFF-".$codigounico.$_FILES['imagen']['name']);
		 
		 if($dim[0]>=500){
				
				
  						$thumb1=new thumbnail("../public/STAFF-".$codigounico.$_FILES['imagen']['name']); 
					    $thumb1->size_width(500);
					    $thumb1->jpeg_quality(90);
					    $thumb1->save("../public/STAFF-".$codigounico.$_FILES['imagen']['name']);
					...
					<header class="page-header">
						...
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Nueva Persona</h2>
							</header>
							...
							<div class="panel-body">
                            	<div style="margin-bottom:10px;">
									<a href="staff.php" class="mb-xs mt-xs mr-xs btn btn-default"><li class="fa fa-arrow-circle-o-left"></li> Regresar</a>
								...
								<div>
                                            ...
                                            <div class="form-group">
												<label class="col-md-3 control-label" for="inputDisabled">Embed</label>
												<div class="col-md-6">
											...
											<div class="form-group">
												<label class="col-md-3 control-label" for="inputSuccess">Estado de la persona</label>
												<div class="col-md-6">
