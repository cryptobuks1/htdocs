...
$iva = $_REQUEST['iva']; //impuestos calculados de la transacción
...
$emailComprador=$_REQUEST['emailComprador']; //email al que llega confirmación del estado final de la transacción, forma de identificar al comprador
