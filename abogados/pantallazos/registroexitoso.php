...
<div class="actualizardatos">
	...
	<div class="titulo_act">
        	Usuario agregado correctamente!</br></br>
			<span style="font-size:16px; font-family:'Lucida Sans Unicode', 'Lucida Grande', sans-serif; color:#666666">Será registrado a www.abogadosweb.com.co en 3 segundos</span>  
	</div>
    <div class="ac_datos">
