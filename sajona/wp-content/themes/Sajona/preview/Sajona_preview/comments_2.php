...
<li <?php comment_class(); ?> id="li-comment-<?php comment_ID(); ?>">
    ...
    <div class="data-control-id-1475 bd-comment-2 <?php echo $comment->comment_type ?>">
        <div class="data-control-id-1361 bd-layoutcontainer-18">
 ...
 bd-row-align-top
                ...
                ">
                <div class="data-control-id-1357 
 col-md-2">
    <div class="bd-layoutcolumn-40"><div class="bd-vertical-align-wrapper"><div class="data-control-id-1349 bd-commentavatar-2">
    <?php echo theme_get_avatar(array('class' => 'data-control-id-1341 bd-imagestyles'), true);  ?>
</div></div></div>
</div>
	
		<div class="data-control-id-1359 
 col-md-22">
    <div class="bd-layoutcolumn-41"><div class="bd-vertical-align-wrapper"><div class="data-control-id-1340 bd-commentmetadata-2 comment-meta commentmetadata">
...
?>
<div class="data-control-id-1514 bd-comments-2">
	<div class="bd-container-inner">
    ...
    if (!function_exists('theme_comment_form_defaults_filter_2')){
        function theme_comment_form_defaults_filter_2($defaults) {
            ...
            $defaults['comment_notes_after'] = '<p class="form-allowed-tags">'
                . sprintf('<label class="data-control-id-191702 bd-bootstraplabel">' . __( 'You may use these <abbr title="HyperText Markup Language">HTML</abbr> tags and attributes: %s' ) . '</label>', ' <code>' . allowed_tags() . '</code>')
                . '</p>';
            return $defaults;
        }
