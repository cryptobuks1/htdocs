<?php 
            ...
            <li itemprop="reviews" itemscope itemtype="http://schema.org/Review" <?php comment_class(); ?> id="li-comment-<?php comment_ID() ?>">
                <div  id="comment-<?php comment_ID(); ?>" class="comment_container data-control-id-3185 bd-productreview-1">
                    <div class="comment-text">
                        <div class="data-control-id-3100 bd-layoutcontainer-30">
 ...
 bd-row-align-top
                ...
                ">
                <div class="data-control-id-3096 
 col-md-2">
    <div class="bd-layoutcolumn-68"><div class="bd-vertical-align-wrapper"><div class="data-control-id-3094 bd-reviewavatar-1"><?php echo theme_get_avatar(array('class' => 'data-control-id-3086 bd-imagestyles'), true); ?></div></div></div>
</div>
	
		<div class="data-control-id-3098 
 col-md-22">
    <div class="bd-layoutcolumn-69"><div class="bd-vertical-align-wrapper"><div class="data-control-id-3075 bd-reviewmetadata-1">
    ...
    <?php } ?>
		...
		<div class='data-control-id-3084 bd-rating'>
    <?php
    $rating = esc_attr( get_comment_meta( $GLOBALS['comment']->comment_ID, 'rating', true ) ); 
    for ($i = 1; $i <= 5; $i++) { 
		$active = ($i <= $rating ? ' active' : ''); ?>
		<span class="data-control-id-3083 bd-icon-3 <?php echo $active ?>"></span>
    <?php } ?>
</div>
