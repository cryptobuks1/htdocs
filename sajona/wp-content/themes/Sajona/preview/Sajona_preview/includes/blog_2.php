...
?>
    ...
    <div class="bd-container-inner">
        <?php echo theme_get_post_thumbnail(array('imageClass' => 'data-control-id-1007943 bd-imagestyles', 'class' => 'data-control-id-1007944 bd-postimage-7')); ?>
...
<?php
    ...
    if ( $wp_query->max_num_pages > 1 ) {
        echo preg_replace(
            ...
            array(
                '<li class="data-control-id-1401 data-control-id-1401 bd-paginationitem-15 active"$1',
                '<ul class="data-control-id-1402 data-control-id-1402 bd-pagination-15 pagination"',
                '<li class="data-control-id-1401 bd-paginationitem-15">'
            ),
