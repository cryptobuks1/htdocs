...
function theme_breadcrumbs_items_1(){
    ...
    if ( !is_front_page() ) {
        $items[] = theme_breadcrumbs_link_1(get_home_url(), '', __('Home', THEME_NS));
    }
    ...
    if(is_tag()){
        $items[] = theme_breadcrumbs_text_1(__("Tag: ", THEME_NS) . single_tag_title('', FALSE));
    }
    if(is_404()){
        $items[] = theme_breadcrumbs_text_1(__("404 - Page not Found", THEME_NS));
    }
    if(is_search()){
        $items[] = theme_breadcrumbs_text_1(__("Search", THEME_NS));
    }
    if(is_year()){
        $items[] = theme_breadcrumbs_text_1(get_the_time('Y'));
    }
    if(is_author()){
        $items[] = theme_breadcrumbs_text_1(sprintf( esc_attr(__( 'View all posts by %s', THEME_NS )), get_the_author() ));
    }
