...
<?php
    ...
    if ( $wp_query->max_num_pages > 1 ) {
        echo preg_replace(
            ...
            array(
                '<li class="data-control-id-1866 data-control-id-1866 bd-paginationitem-8 active"$1',
                '<ul class="data-control-id-1867 data-control-id-1867 bd-pagination-8 pagination"',
                '<li class="data-control-id-1866 bd-paginationitem-8">'
            ),
