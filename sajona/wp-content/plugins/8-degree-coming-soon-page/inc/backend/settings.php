...
<?php if(isset($_SESSION['save_msg'])){ ?>
   <p class="sesion-msg"><?php echo $_SESSION['save_msg'];unset($_SESSION['save_msg']);?></p>
  <?php }
    if(isset($_SESSION['ap_message'])){ ?>
       <p class="sesion-msg"><?php echo $_SESSION['ap_message']; unset($_SESSION['ap_message']); ?></p> 
  <?php  }
   ?>
 </div>
               ...
               <?php
                    ...
                    if (count($user_sets) > 0) {
                     ...
                     <?php }
                        ...
                        <tr><td colspan="2"><div class="edmm-noresult"><?php _e('No Subscribers Found', 'front-user-manage'); ?></div></td></tr>
                  <?php   } ?>
