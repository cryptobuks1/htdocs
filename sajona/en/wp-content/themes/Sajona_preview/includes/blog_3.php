...
?>
                ...
                <div class="separated-item-21 col-md-24 ">
                    ...
                    <div class="bd-griditem-21">
                        <article id="<?php echo $id; ?>" class="data-control-id-1657 bd-article-4 clearfix <?php echo $class; ?>">
    <?php echo theme_get_post_thumbnail(array('imageClass' => 'data-control-id-1521 bd-imagestyles', 'class' => 'data-control-id-1522 bd-postimage-3')); ?>
...
<?php
    ...
    if ( $wp_query->max_num_pages > 1 ) {
        echo preg_replace(
            ...
            array(
                '<li class="data-control-id-1617 data-control-id-1617 bd-paginationitem-10 active"$1',
                '<ul class="data-control-id-1618 data-control-id-1618 bd-pagination-10 pagination"',
                '<li class="data-control-id-1617 bd-paginationitem-10">'
            ),
