...
?>
                ...
                <div class="separated-item-18 col-md-24 ">
                    ...
                    <div class="bd-griditem-18">
                        <article id="<?php echo $id; ?>" class="data-control-id-1166 bd-article-2 clearfix <?php echo $class; ?>">
    <?php
...
?>
    ...
    <span class="data-control-id-1016 bd-icon-34"><span><?php echo get_the_date(); ?></span></span>
</div>
    ...
    <a href="<?php echo get_author_posts_url(get_the_author_meta('ID')) ?>" title="<?php echo esc_attr(__('View all posts by ' . get_the_author(), THEME_NS)) ?>">
        <span class="data-control-id-1025 bd-icon-36"><span><?php echo get_the_author(); ?></span></span>
    </a>
</div>
    </div>
</div>
    ...
    <div class="bd-container-inner">
        <?php echo theme_get_post_thumbnail(array('imageClass' => 'data-control-id-1008 bd-imagestyles', 'class' => 'data-control-id-1009 bd-postimage-2')); ?>
...
<a class="bd-postreadmore-4 bd-button data-control-id-1002005" title="<?php echo strip_tags($text) ?>" href="<?php echo get_permalink($post->ID) ?>"><?php echo $text; ?></a>
<?php
    }
}
?>
    ...
    <?php if ($tags_list): ?>
    <span class="data-control-id-1001967 bd-icon-10"><span><?php echo $tags_list; ?></span></span>
    <?php endif; ?>
</div>
    </div>
</div>
...
<?php
    ...
    if ( $wp_query->max_num_pages > 1 ) {
        echo preg_replace(
            ...
            array(
                '<li class="data-control-id-1126 data-control-id-1126 bd-paginationitem-12 active"$1',
                '<ul class="data-control-id-1127 data-control-id-1127 bd-pagination-12 pagination"',
                '<li class="data-control-id-1126 bd-paginationitem-12">'
            ),
