            ...
            <tr>
                <td colspan="6">
                    <div class="data-control-id-44550 bd-container-53 bd-tagstyles bd-custom-button">
                        ...
                        <input class="data-control-id-44543 bd-button-15" type="submit" name="proceed" value="<?php _e('Proceed to Checkout &rarr;', 'woocommerce'); ?>" />
                        <?php
                    ...
                    if ( $_product->exists() && $values['quantity'] > 0 ) {
                        ...
                        <tr <?php if ($i % 2 === 0): ?>class="alt"<?php endif ?>>
                            ...
                            <td class="product-thumbnail">
                                <?php $thumbnail = apply_filters( 'woocommerce_in_cart_product_thumbnail', $_product->get_image('shop_thumbnail', array('class' => 'data-control-id-2825 bd-imagestyles')), $values, $cart_item_key ); ?>
    ...
    ?>
                            ...
                            <td class="product-quantity">
                                ...
                                if ( $_product->is_sold_individually() ) {
                                    ...
                                    $product_quantity = sprintf( '<div class="quantity"><input type="text" name="cart[%s][qty]" data-min="%s" data-max="%s" value="%s" size="4" title="Qty" class="qty data-control-id-2847 bd-bootstrapinput form-control" maxlength="12" /></div>', $cart_item_key, $data_min, $data_max, esc_attr( $values['quantity'] ));
                                }
