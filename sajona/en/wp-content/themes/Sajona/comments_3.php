...
<li <?php comment_class(); ?> id="li-comment-<?php comment_ID(); ?>">
    ...
    <div class=" bd-comment-3 <?php echo $comment->comment_type ?>">
        <div class=" bd-layoutcontainer-19">
 ...
 bd-row-align-top
                ...
                <div class=" 
 col-md-2">
    <div class="bd-layoutcolumn-42"><div class="bd-vertical-align-wrapper"><div class=" bd-commentavatar-3">
    <?php echo theme_get_avatar(array('class' => ' bd-imagestyles'), true);  ?>
		...
		<div class=" 
 col-md-22">
    <div class="bd-layoutcolumn-43"><div class="bd-vertical-align-wrapper"><div class=" bd-commentmetadata-3 comment-meta commentmetadata">
