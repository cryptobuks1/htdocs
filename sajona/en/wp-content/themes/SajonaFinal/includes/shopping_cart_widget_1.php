...
function theme_cart() {
 ...
 bd-row-align-top
                ...
                <div class=" 
 col-md-6">
    <div class="bd-layoutcolumn-1"><div class="bd-vertical-align-wrapper"><a class=" bd-productimage-1" href="<?php echo $product_view['link']; ?>"><?php theme_product_image($product_view, ' bd-imagestyles'); ?></a></div></div>
</div>
	
		<div class=" 
 col-md-14">
    <div class="bd-layoutcolumn-2"><div class="bd-vertical-align-wrapper"><?php if ( isset($product_view['link']) && isset($product_view['title']) ){ ?><div class=" bd-producttitle-2"><a href="<?php echo $product_view['link']; ?>"><?php echo $product_view['title']; ?></a></div><?php } ?>
