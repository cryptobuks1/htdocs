...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-02-2017 a las 17:22:36
...
(27, 5, 2, 'Mexicano', 'Sabor Mexicano SIN PICANTE!', 'En 20cm de baguette, Pollo, queso, jamón, nachos, guacamole, lechuga, tomate, cebollas, crema Espigal.', '1.25', 'mexicano.jpg'),
...
(32, 6, 0, 'BBQ', '(15 cm)', 'Pollo, queso, tocino, salsa BBQ, lechuga, tomate, crema El Espigal', '3.99', 'Sanduche BBQ.JPG'),
(33, 6, 0, 'Deluxe', '(15 cm)', 'Jamón, queso holandés, queso cheddar, champiñones, lechuga, tomate, crema El Espigal.', '3.75', 'Sanduche deluxe.JPG'),
...
(38, 6, 0, 'Pizza Italiano', '(20 cm)', 'Peperoni, queso, jamón, orégano, lechuga, tomate, crema El Espigal. ', '3.99', 'italiano.jpg'),
(39, 6, 0, 'Club', '(20 cm)', 'Jamón, queso, tocino, pollo, lechuga, tomate, crema El Espigal.', '4.75', 'Sanduche Club.JPG'),
...
(42, 7, 0, 'Picadita Mixta', '(GRANDE)', 'Combinación de embutidos acompañado de encurtidos, vegetales y crema Espigal.', '9.99', 'mixtagrande.jpg'),
...
(44, 8, 0, 'Ensalada César (Pollo)', '', 'Ensalada fresca con pollo, trozos de tocino, crutones, lechuga, tomatey nuestra deliciosa vinagreta de yogurt Cesar.', '4.99', 'ensaladacesar.jpg'),
...
(46, 13, 0, 'Mouse maracuyá', '', 'El Postre Que Debes PROBAR! El Toque Acido Del Maracuyá Con La Textura Y Sabor Único.', '1.25', 'mousse.jpg'),
...
(76, 11, 0, 'Jumbo Naranja', '', 'Jumbo Naranja', '3.00', 'JumboNaranja.jpg'),
...
(12, 'desayunomovil.jpg', 2, 0, 0, 0, 0, 0, 'movil');
...
(43, '1', '', 'julian Agudelo', 'la peninsula', '244', 'julian@jdsf.com', 'dsaj', '', ''),
(44, '7852', '', 'ju', 'ty', '1', 'j@jdsf.com', 'er', '', ''),
(45, '7946113', '', 'juli', 'dsfjasl', '4', 'j@jdsf.com', 'sdjfalj', '', ''),
(46, '4', '', 'Pedro', 'Ficoa', '4', 'lupaclick@gmail.com', 'AL', '', ''),
(47, 'f', '', 'hola', 'sdjaflsj', 'f', '', 'dsfjaflkj', '', ''),
(48, '2', '', 'julian', 'sdfas', '2', 'lupaclick@gmail.com', 'sdaf', '', ''),
(52, '1756754063', '', 'Julian Agudelo', 'Bolívar y Fernández esquina', '2822184', 'lupaproyectos@gmail.com', 'Arriba de las tortillas de la Bolívar 3er piso', '', '');
...
--
ALTER TABLE `adicionales`
MODIFY `id_adicional` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=20;
--
-- AUTO_INCREMENT de la tabla `adicional_producto`
--
ALTER TABLE `adicional_producto`
MODIFY `id_ad_prod` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=185;
--
...
--
-- AUTO_INCREMENT de la tabla `produ`
--
ALTER TABLE `produ`
