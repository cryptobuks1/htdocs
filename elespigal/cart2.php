        ...
        <div id="scrollContent">
            <ul>
                <li>
                    ...
                    if(isset($_SESSION['total']) && $_SESSION['total']!=$domicilio){?>
                       ...
                       <?php if($_SESSION['suma']>-1){
                        echo"<button class='boton rpedido'><span class='icon-car carbtn'></span>Realizar Pedido<div class='cargando '><i class='fa fa-spinner fa-pulse'></i></div></button>";
                        }else{
                            echo"<button class='boton  rpedido'>Realizar Pedido (<small>mínimo $8</small>)</button>";
                        }?>
                        ...
                        <button class="btnsinp rpedido">Realizar Pedido<div class='cargando '><i class='fa fa-spinner fa-pulse'></i></div></button>
