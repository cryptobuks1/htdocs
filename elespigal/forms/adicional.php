<div class="cont-adi ">
    <div class="item-info">
        <h4 class="red bold">Extras <font>(Opcional)</font></h4>
        
        <div class="error-msg"></div>
    </div>
    <div class="item-group <?php echo $filaG['grupo'] ?>" data-idgroup="1" data-nameg="Extras" data-group="<?php echo $filaG['grupo'] ?>">
        <form name="adicionales">
            ...
            while($col = mysqli_fetch_array($resI)){
               ...
               <?php while($fila1 = mysqli_fetch_array($resultado1)){?>
                <label class="addi">
                    <input data-id="<?php echo $fila1['id_adicional'] ?>" data-form="<?php echo $filaG['grupo'] ?>" data-group="Extras" data-price="<?php echo $fila1['valor'] ?>"  data-name="<?php echo $fila1['nombre'] ?>" name="itemAddi" id="196530" class="itemAddi" type="checkbox" value="<?php echo $col['id_adicional']?>">
           ...
           <?php }?>
           <label class="addi">
                <input class="no" data-group="<?php echo $filaG['grupo'] ?>" type="checkbox" checked>
                <!--<input type="number" min="0" class="cant-adicional <?php echo $fila1['nombre'] ?>" value="0" data-name="<?php echo $fila1['nombre'] ?>">-->
                <!--<div class="img-ad"><img src="fotos/<?php echo $fila1['imagen'] ?>"></div>-->
                <span>No</span>
