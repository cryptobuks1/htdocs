...
<?php include("MS-cabezoteCart.php"); ?>
                       ...
                       <div class="row b-col-default-indent">
                            <div class="col-md-6 ">
                                <?php if(isset($_SESSION['user'])){
                                    if(isset($_SESSION['carrito'])){?>
                                    <form action="MS-procesar-pedido.php" method="post" class="formPago">
                                    ...
                                    <div class="b-tabs f-tabs j-tabs b-tabs-reset b-tabs--secondary f-tabs--secondary">
                                        ...
                                        <div id="tabs-31" class="clearfix">
                                            <div class="b-form-row b-form-inline b-form-horizontal">
                                                ...
                                                <form action="MS-inicio-sesion.php" method="post">
                                                    <div class="col-xs-12">
                                        ...
                                        <div id="tabs-32" class="clearfix">
                                            ...
                                            <div class="row b-form-inline b-form-horizontal">
                                                <div class="col-xs-12">
                                                    <form action="MS-crear-cuenta.php" method="post">
                                                        <div class="b-form-row">
