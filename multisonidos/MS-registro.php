<?php $mipagina = "registro"; ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    <title>Registro | MULTISONIDO</title>
...
<div class="b-inner-page-header f-inner-page-header b-bg-header-inner-page">
  <div class="b-inner-page-header__content">
    <div class="container">
      <h1 class="f-primary-l c-default">Registro: Crea una cuenta</h1>
    </div>
  </div>
</div>
<div class="l-main-container">
    ...
    <div class="container b-container-login-page">
        <div class="row">
            <div class="col-md-6">
                <div class="b-form-row f-primary-l f-title-big c-secondary"> <strong>Registro: </strong> Crea una cuenta</div>
