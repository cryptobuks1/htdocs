...
<div class="b-inner-page-header f-inner-page-header b-bg-header-inner-page">
  <div class="b-inner-page-header__content">
    <div class="container">
      <h1 class="f-primary-l c-default">Identificate</h1>
    </div>
  </div>
</div>
    ...
    <div class="b-breadcrumbs f-breadcrumbs">
        <div class="container">
            <ul>
                ...
                <li><i class="fa fa-angle-right"></i> Loguin </li>
            </ul>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="b-log-in-form">
                    <div class="f-primary-l f-title-big c-secondary"> Identificate </div>
                    <p>Ingresar a tu cuenta</p>
                    <hr class="b-hr" />
                    <div class="b-form-row b-form-inline b-form-horizontal">
                        <form action="MS-login.php" method="post">
                            <div class="col-xs-12">
            ...
            <div class="col-md-6">
                <div class="f-primary-l f-title-big c-secondary">Bienvenido a Multisonidos</div>
                <p>Si aún no tienes una cuenta puedes registrarte de manera gratuita, y de esta manera cuando necesites uno de nuestros podructos lo puedas obtener de una manera rapida y confiable. </p>
                <div class="b-shortcode-example">
                    <ul class="b-list-markers f-list-markers">
                        <li><a href="MS-registro.php" class="button-sm button-turquoise"><i class="fa fa-check-circle b-list-markers__ico f-list-markers__ico"></i> Creaer una cuenta </a></li>
                        <li><a href="MS-recordar-pass.php" class="button-sm button-blue"><i class="fa fa-check-circle b-list-markers__ico f-list-markers__ico"></i> Olvide mi usuario y contraseña</a></li>
                    </ul>
                </div>
            </div>
        </div>
