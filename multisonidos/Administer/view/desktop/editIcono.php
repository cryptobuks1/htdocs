						...
						<section class="panel">
                            ...
                            <div class="container-fluid">
                                ...
                                <div class="card mb-3 mt-1">
                                    ...
                                    <?php } ?>
                                    <div class="card-body ">
                                        <?php $iconos=$ic->getById($_GET['id']);  ?>
                                        <form id="loginForm" action="editIcono.php?id=<?php echo $_GET['id'] ?>" method="POST"  class="form-horizontal" >
                                            <div class="form-row">
                                                <div class="col-md-2 col-md-offset-5">
                                                    <div class="form-group iconos">
                                                        <label><span class="text-label">*Icono actual</span></label><br/>
                                                            <label class=" labelIcono w-100"><h3 class="icono"><i class="<?php echo $iconos->icon ?>" style="font-size: 90px" ></i> </h3></label>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 col-md-offset-3">
                                                    <div class="form-group">
                                                        <label><span class="text-label">*Icono clase</span></label>
                                                        <input class="form-control" type="text" name="icono" value="<?php echo $iconos->icon ?>">
                                                    </div>
                                                </div>
                                                <div class="col-md-6 col-md-offset-3">
