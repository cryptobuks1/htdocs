...
class Categoria extends Mysqli
{
    ...
    public function save(){
        ...
        $query="INSERT INTO categorias (id, nombre, tag, posicion, img)"
    ...
    public function update($id){
        $query="UPDATE categorias SET nombre='".$this->nombre."',  tag='".$this->tag."', posicion='".$this->posicion."',img='".$this->img."' WHERE id=$id";
