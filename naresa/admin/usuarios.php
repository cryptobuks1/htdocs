...
<table cellspacing="0">
    <tr>
        <th>No.</th><th>NOMBRE</th><th>APELLIDOS</th><th>CORREO</th><th>RUC</th><th>TIPO USER</th><th>DIRECCION</th><th>TELEFONO</th><th>PAIS</th><th>CIUDAD-PROVINCIA</th><?php if($_SESSION['usuario']['p']=='admin' || $_SESSION['usuario']['p']=='Admin'){?><th>EDITAR</th><th>ELIMINAR</th><?php }?>
    </tr>
<?php
