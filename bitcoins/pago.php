...
// bitcoin/altcoin payment box; open source
	...
	$amountUSD		= $_GET['valor'];			// invoice amount - 2.21 USD; or you can use - $amountUSD = convert_currency_live("EUR", "USD", 22.37); // convert 22.37EUR to USD
	...
	$all_keys = array(	"bitcoin"  => 		array("public_key" => "25276AAMX31yBitcoin77BTCPUBIra1IBRssY7yFyNOwjzYNqV",  "private_key" => "25276AAMX31yBitcoin77BTCPRVn4Sn5XOwMI2cu2f41AbAQkG")); // etc.
			 
	// Demo Keys; for tests	(example - 5 coins)
	$all_keys = array(	"bitcoin" => array(		"public_key" => "25276AAMX31yBitcoin77BTCPUBIra1IBRssY7yFyNOwjzYNqV",  
										"private_key" => "25276AAMX31yBitcoin77BTCPRVn4Sn5XOwMI2cu2f41AbAQkG")); // Demo keys!
