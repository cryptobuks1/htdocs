 ...
 * @since      1.0.0
 */
class FireUp_Video_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			'classname'   => 'widget-fireup-video video-widget',
			'description' => __( 'Easily to display any type of video.', 'fireup' )
		);

		// Create the widget.
		$this->WP_Widget(
			'fireup-video',                  // $this->id_base
			__( '&raquo; Video', 'fireup' ), // $this->name
