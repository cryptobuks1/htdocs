 ...
 * @since      1.0.0
 */
class FireUp_Ads_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			'classname'   => 'widget-fireup-ad ad-widget',
			'description' => __( 'Easily to display any type of ad.', 'fireup' )
		);

		// Create the widget.
		$this->WP_Widget(
			'fireup-ads',                            // $this->id_base
			__( '&raquo; Advertisement', 'fireup' ), // $this->name
	...
	function form( $instance ) {
		...
		// Default value.
		$defaults = array(
			'title'   => esc_html__( 'Advertisement', 'fireup' ),
			'ad_code' => '',
		);
