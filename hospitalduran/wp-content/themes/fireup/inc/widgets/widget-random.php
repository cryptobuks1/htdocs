 ...
 * @since      1.0.0
 */
class FireUp_Random_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			'classname'   => 'widget-fireup-random posts-thumbnail-widget',
			'description' => __( 'Display random posts with thumbnails.', 'fireup' )
		);

		// Create the widget.
		$this->WP_Widget(
			'fireup-random',                                   // $this->id_base
			__( '&raquo; Random Posts Thumbnails', 'fireup' ), // $this->name
	...
	function form( $instance ) {
		...
		// Default value.
		$defaults = array(
			'title'     => esc_html__( 'Random Posts', 'fireup' ),
			'limit'     => 5,
			'show_date' => false
		);
