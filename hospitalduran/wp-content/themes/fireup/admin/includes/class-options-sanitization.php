...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'fireup' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'fireup' ),
		'repeat-y'  => __( 'Repeat Vertically', 'fireup' ),
		'repeat'    => __( 'Repeat All', 'fireup' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'fireup' ),
		'top center'    => __( 'Top Center', 'fireup' ),
		'top right'     => __( 'Top Right', 'fireup' ),
		'center left'   => __( 'Middle Left', 'fireup' ),
		'center center' => __( 'Middle Center', 'fireup' ),
		'center right'  => __( 'Middle Right', 'fireup' ),
		'bottom left'   => __( 'Bottom Left', 'fireup' ),
		'bottom center' => __( 'Bottom Center', 'fireup' ),
		'bottom right'  => __( 'Bottom Right', 'fireup')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'fireup' ),
		'fixed'  => __( 'Fixed in Place', 'fireup')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'fireup' ),
		'italic'      => __( 'Italic', 'fireup' ),
		'bold'        => __( 'Bold', 'fireup' ),
		'bold italic' => __( 'Bold Italic', 'fireup' )
		);
