...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'imedical' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'imedical' ),
		'repeat-y'  => __( 'Repeat Vertically', 'imedical' ),
		'repeat'    => __( 'Repeat All', 'imedical' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'imedical' ),
		'top center'    => __( 'Top Center', 'imedical' ),
		'top right'     => __( 'Top Right', 'imedical' ),
		'center left'   => __( 'Middle Left', 'imedical' ),
		'center center' => __( 'Middle Center', 'imedical' ),
		'center right'  => __( 'Middle Right', 'imedical' ),
		'bottom left'   => __( 'Bottom Left', 'imedical' ),
		'bottom center' => __( 'Bottom Center', 'imedical' ),
		'bottom right'  => __( 'Bottom Right', 'imedical')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'imedical' ),
		'fixed'  => __( 'Fixed in Place', 'imedical')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'imedical' ),
		'italic'      => __( 'Italic', 'imedical' ),
		'bold'        => __( 'Bold', 'imedical' ),
		'bold italic' => __( 'Bold Italic', 'imedical' )
		);
