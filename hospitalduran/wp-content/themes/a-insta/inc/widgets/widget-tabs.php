 ...
 * @since      1.0.0
 */
class iMedical_Tabs_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			'classname'   => 'widget-imedical-tabs widget_tabs posts-thumbnail-widget',
			'description' => __( 'Display popular posts, recent posts, recent comments and tags in tabs.', 'imedical' )
		);

		// Create the widget.
		$this->WP_Widget(
			'imedical-tabs',                  // $this->id_base
			__( '&raquo; Tabs', 'imedical' ), // $this->name
	...
	function widget( $args, $instance ) {
		...
		<ul class="tabs-nav">
			<li class="active"><a href="#tab1" title="<?php esc_attr_e( 'Popular', 'imedical' ); ?>"><?php _e( 'Popular', 'imedical' ); ?></a></li>
			<li><a href="#tab2" title="<?php esc_attr_e( 'Latest', 'imedical' ); ?>"><?php _e( 'Latest', 'imedical' ); ?></a></li>
			<li><a href="#tab3" title="<?php esc_attr_e( 'Comments', 'imedical' ); ?>"><?php _e( 'Comments', 'imedical' ); ?></a></li>        
			<li><a href="#tab4" title="<?php esc_attr_e( 'Tags', 'imedical' ); ?>"><?php _e( 'Tags', 'imedical' ); ?></a></li>
		</ul>

		<div class="tabs-container">
			<div class="tab-content" id="tab1">
				<?php echo imedical_popular_posts( (int) $instance['popular_num'] ); ?>
			</div>

			<div class="tab-content" id="tab2">
				<?php echo imedical_latest_posts( (int) $instance['recent_num'] ); ?>
			</div>
	...
	?>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'popular_num' ); ?>">
				<?php _e( 'Number of Popular Posts', 'imedical' ); ?>
			</label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'recent_num' ); ?>">
				<?php _e( 'Number of Recent Posts', 'imedical' ); ?>
			</label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'comments_num' ); ?>">
				<?php _e( 'Number of Recent Comments', 'imedical' ); ?>
			</label>
 ...
 * @since 1.0.0
 */
function imedical_popular_posts( $number = 5 ) {
			...
			foreach ( $popular as $post ) :
				...
				$html .= '<li class="clearfix">';
					$html .= '<a href="' . esc_url( get_permalink( $post->ID ) ) . '" rel="bookmark">';
						$html .= get_the_post_thumbnail( $post->ID, 'imedical-widget-thumb', array( 'class' => 'entry-thumbnail', 'alt' => esc_attr( get_the_title( $post->ID ) ) ) );
 ...
 * @since 1.0.0
 */
function imedical_latest_posts( $number = 5 ) {
