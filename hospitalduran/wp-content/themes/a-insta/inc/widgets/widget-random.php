 ...
 * @since      1.0.0
 */
class iMedical_Random_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			'classname'   => 'widget-imedical-random posts-thumbnail-widget',
			'description' => __( 'Display random posts with thumbnails.', 'imedical' )
		);

		// Create the widget.
		$this->WP_Widget(
			'imedical-random',                                   // $this->id_base
			__( '&raquo; Random Posts Thumbnails', 'imedical' ), // $this->name
	...
	function form( $instance ) {
		...
		// Default value.
		$defaults = array(
			'title'     => esc_html__( 'Random Posts', 'imedical' ),
			'limit'     => 5,
			'show_date' => false
		);
