 ...
 * @since      1.0.0
 */
class iMedical_Video_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			'classname'   => 'widget-imedical-video video-widget',
			'description' => __( 'Easily to display any type of video.', 'imedical' )
		);

		// Create the widget.
		$this->WP_Widget(
			'imedical-video',                  // $this->id_base
			__( '&raquo; Video', 'imedical' ), // $this->name
	...
	function form( $instance ) {
		...
		// Default value.
		$defaults = array(
			'title'      => esc_html__( 'Video', 'imedical' ),
			'video_url'  => '',
			'video_code' => ''
		);
