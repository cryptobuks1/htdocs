 ...
 * @since      1.0.0
 */
class iMedical_Ads_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			'classname'   => 'widget-imedical-ad ad-widget',
			'description' => __( 'Easily to display any type of ad.', 'imedical' )
		);

		// Create the widget.
		$this->WP_Widget(
			'imedical-ads',                            // $this->id_base
			__( '&raquo; Advertisement', 'imedical' ), // $this->name
	...
	function form( $instance ) {
		...
		// Default value.
		$defaults = array(
			'title'   => esc_html__( 'Advertisement', 'imedical' ),
			'ad_code' => '',
		);
