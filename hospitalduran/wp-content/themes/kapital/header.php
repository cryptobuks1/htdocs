...
<head>
	...
	<link rel="pingback" href="<?php bloginfo('pingback_url'); ?>" />
        ...
        <script type="text/javascript" src="js/onhovermeddep.js"></script>
				...
				<div class="header-top">
					...
					<div class="container nz-clearfix">
						...
						<?php if ($nz_desk_sl_align == "left"): ?>
							...
							<?php endif ?>
                                                        <div class="pt" style="margin-left: -6.4%; position: absolute; width: 100%;">
                                                        <a href="http://hospitalduran.com/index.php/trabajo/"><div class="trabajo" style="float: left;  padding-left: 15px;  border-left: 1px solid rgba(255,255,255,0.1); height: 40px; width: 92px; margin-left: 9.4%;position: absolute; color:white; font-weight: bold;"><i class="fa fa-briefcase" style="font-size: 15px; color: white; margin-right: 6px;"></i>Trabajo</div></a>
                                                        <a href="http://hospitalduran.com/index.php/pasantias/"><div class="trabajo" style="float: left;  padding-left: 15px;  border-left: 1px solid rgba(255,255,255,0.1); height: 40px; width: 98px; margin-left: 16.8%;position: absolute; color:white; font-weight: bold;"><i class="fa fa-book" style="font-size: 15px; color: white; margin-right: 6px;"></i></i>Pasant&iacute;a</div></a>
                                                        </div>
