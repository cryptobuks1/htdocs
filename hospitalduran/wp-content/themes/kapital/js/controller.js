...
/*======================*/
	...
	(function($){
		...
		toggleLangHover($('.widget_icl_lang_sel_widget #lang_sel ul li'));
                ...
                $('#menu-item-504').mouseenter(function(){
                    $('.div1').css("display", "block");

                });
                $('#menu-item-504').mouseleave(function(){
                    $('.div1').css("display", "none");

                });
                $('#menu-item-505').mouseenter(function(){
                    $('.div2').css("display", "block");

                });
                $('#menu-item-505').mouseleave(function(){
                    $('.div2').css("display", "none");

                });
                 $('#menu-item-506').mouseenter(function(){
                    $('.div3').css("display", "block");

                });
                $('#menu-item-506').mouseleave(function(){
                    $('.div3').css("display", "none");

                });
                 $('#menu-item-507').mouseenter(function(){
                    $('.div4').css("display", "block");

                });
                $('#menu-item-507').mouseleave(function(){
                    $('.div4').css("display", "none");

                });
                 $('#menu-item-508').mouseenter(function(){
                    $('.div5').css("display", "block");

                });
                $('#menu-item-508').mouseleave(function(){
                    $('.div5').css("display", "none");

                });
                 $('#menu-item-509').mouseenter(function(){
                    $('.div6').css("display", "block");

                });
                $('#menu-item-509').mouseleave(function(){
