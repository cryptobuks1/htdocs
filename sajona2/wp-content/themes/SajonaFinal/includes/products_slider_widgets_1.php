        ...
        if ($query->have_posts()) : ?>
            ...
            ?>
                <div class="<?php echo $item_class; ?>">
                    <div class=" bd-griditem-2"><a class=" bd-productimage-2" href="<?php echo $product_view['link']; ?>"><?php theme_product_image($product_view, ' bd-imagestyles-15'); ?></a>
...
?>
    ...
    <span class="price"><?php
        echo theme_price_html(
            ...
            '<div class=" bd-pricetext-6">', '</div>',
            
 false, ' bd-container-8 bd-tagstyles bd-custom-blockquotes bd-custom-button bd-custom-image bd-custom-table',
            '<div class=" bd-pricetext-5">', '</div>',
            
 false, ' bd-container-13 bd-tagstyles bd-custom-blockquotes bd-custom-button bd-custom-image bd-custom-table');
?></span>
<?php
        }
?>
		...
		<?php theme_product_buy(' bd-productbuy-1 bd-button'); ?></div>
                </div>
