...
//die();
   if(isset($_POST['save_options'])){
    ...
    $maintenance_data['description'] = sanitize_text_field($_POST['description']);
    ...
    $maintenance_data['note_subscriber'] = sanitize_text_field($_POST['note_subscriber']);
    ...
    /*$maintenance_data['fb_link'] = sanitize_text_field($_POST['fb_link']);
    $maintenance_data['tw_link'] = sanitize_text_field($_POST['tw_link']);
    $maintenance_data['pin_link'] = sanitize_text_field($_POST['pin_link']);
    $maintenance_data['goog_link'] = sanitize_text_field($_POST['goog_link']);
    $maintenance_data['linked_link'] = sanitize_text_field($_POST['linked_link']);
    $maintenance_data['tumb_link'] = sanitize_text_field($_POST['tumb_link']); */
   ...
   /* $maintenance_data['is_editor'] = isset($_POST['is_editor'])?sanitize_text_field($_POST['is_editor']):0;
    $maintenance_data['is_author'] = isset($_POST['is_author'])?sanitize_text_field($_POST['is_author']):0;
    $maintenance_data['is_admin'] = isset($_POST['is_admin'])?sanitize_text_field($_POST['is_admin']):0;
    */
   ...
   /* echo '<pre>';
    ...
    $update=update_option('maintenance_settings',$maintenance_data);
        ...
        $_SESSION['save_msg'] = __('Settings Saved Successfully','ap-plugin');
