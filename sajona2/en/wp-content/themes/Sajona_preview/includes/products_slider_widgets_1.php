...
class Theme_WooCommerce_Widget_Product_Slider extends WP_Widget {
    ...
    function Theme_WooCommerce_Widget_Product_Slider() {
        ...
        $this->WP_Widget($this->widget_custom_init(), $this->woo_widget_name, $widget_ops);
    ...
    function widget($args, $instance) {
        ...
        if ($query->have_posts()) : ?>
            ...
            <?php
                ...
                $width_lg = empty($instance['width_lg']) ? $this->woo_widget_default_width_lg : $instance['width_lg'];
                if ($width_lg) {
                    $item_class .= ' col-lg-' . $width_lg;
                }
                $width = empty($instance['width']) ? $this->woo_widget_default_width : $instance['width'];
                if ($width){
                    $item_class .= ' col-md-' . $width;
                }
                $width_sm = empty($instance['width_sm']) ? $this->woo_widget_default_width_sm : $instance['width_sm'];
                if ($width_sm) {
                    $item_class .= ' col-sm-' . $width_sm;
                }
                $width_xs = empty($instance['width_xs']) ? $this->woo_widget_default_width_xs : $instance['width_xs'];
                if ($width_xs) {
                    $item_class .= ' col-xs-' . $width_xs;
                }
            ?>
                <div class="<?php echo $item_class; ?>">
                    <div class="data-control-id-3534 bd-griditem-2"><a class="data-control-id-200 bd-productimage-2" href="<?php echo $product_view['link']; ?>"><?php theme_product_image($product_view, 'data-control-id-62241 bd-imagestyles-15'); ?></a>
...
?>
    ...
    <span class="price"><?php
        echo theme_price_html(
            $product_view['price'], true, false,
            '<div class="data-control-id-276 bd-pricetext-6">', '</div>',
            
 false, 'data-control-id-275 bd-container-8 bd-tagstyles bd-custom-blockquotes bd-custom-button bd-custom-image bd-custom-table',
            '<div class="data-control-id-242 bd-pricetext-5">', '</div>',
            
 false, 'data-control-id-241 bd-container-13 bd-tagstyles bd-custom-blockquotes bd-custom-button bd-custom-image bd-custom-table');
?></span>
<?php
        }
?>
		...
		<?php theme_product_buy('data-control-id-282 bd-productbuy-1 bd-button'); ?></div>
                </div>
    ...
    <a class="data-control-id-3544 bd-carousel-2" href="#">
        <span class="data-control-id-3543 bd-icon-5"></span>
    </a>
</div>
...
<div class="right-button">
    ...
    function form( $instance ) {
        ...
        $options = array('' => '', '24' => '1', '12' => '2', '8' => '3', '6' => '4', '4' => '6', '3' => '8');
...
class Theme_WooCommerce_Widget_Related_Products extends Theme_WooCommerce_Widget_Product_Slider {
    ...
    function widget_get_wp_query($instance) {
        ...
        if (!$product || $product->post->post_name !== $_GET['product'])
            return null;
