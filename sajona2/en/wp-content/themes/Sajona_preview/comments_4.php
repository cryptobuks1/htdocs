...
<li <?php comment_class(); ?> id="li-comment-<?php comment_ID(); ?>">
    ...
    <div class="data-control-id-1940 bd-comment-4 <?php echo $comment->comment_type ?>">
        <div class="data-control-id-1826 bd-layoutcontainer-21">
 ...
 bd-row-align-top
                ...
                ">
                <div class="data-control-id-1822 
 col-md-2">
    <div class="bd-layoutcolumn-47"><div class="bd-vertical-align-wrapper"><div class="data-control-id-1814 bd-commentavatar-4">
    <?php echo theme_get_avatar(array('class' => 'data-control-id-1806 bd-imagestyles'), true);  ?>
</div></div></div>
</div>
	
		<div class="data-control-id-1824 
 col-md-22">
    <div class="bd-layoutcolumn-48"><div class="bd-vertical-align-wrapper"><div class="data-control-id-1805 bd-commentmetadata-4 comment-meta commentmetadata">
...
?>
<div class="data-control-id-1979 bd-comments-4">
	<div class="bd-container-inner">
    ...
    if (!function_exists('theme_comment_form_defaults_filter_4')){
        function theme_comment_form_defaults_filter_4($defaults) {
            ...
            $defaults['comment_notes_after'] = '<p class="form-allowed-tags">'
                . sprintf('<label class="data-control-id-190665 bd-bootstraplabel">' . __( 'You may use these <abbr title="HyperText Markup Language">HTML</abbr> tags and attributes: %s' ) . '</label>', ' <code>' . allowed_tags() . '</code>')
                . '</p>';
            return $defaults;
        }
