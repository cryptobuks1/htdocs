...
<li <?php comment_class(); ?> id="li-comment-<?php comment_ID(); ?>">
    ...
    <div class="data-control-id-1691 bd-comment-3 <?php echo $comment->comment_type ?>">
        <div class="data-control-id-1577 bd-layoutcontainer-19">
 ...
 bd-row-align-top
                ...
                ">
                <div class="data-control-id-1573 
 col-md-2">
    <div class="bd-layoutcolumn-42"><div class="bd-vertical-align-wrapper"><div class="data-control-id-1565 bd-commentavatar-3">
    <?php echo theme_get_avatar(array('class' => 'data-control-id-1557 bd-imagestyles'), true);  ?>
</div></div></div>
</div>
	
		<div class="data-control-id-1575 
 col-md-22">
    <div class="bd-layoutcolumn-43"><div class="bd-vertical-align-wrapper"><div class="data-control-id-1556 bd-commentmetadata-3 comment-meta commentmetadata">
...
?>
<div class="data-control-id-1730 bd-comments-3">
	<div class="bd-container-inner">
    ...
    if (!function_exists('theme_comment_form_defaults_filter_3')){
        function theme_comment_form_defaults_filter_3($defaults) {
            ...
            $defaults['comment_notes_after'] = '<p class="form-allowed-tags">'
                . sprintf('<label class="data-control-id-190480 bd-bootstraplabel">' . __( 'You may use these <abbr title="HyperText Markup Language">HTML</abbr> tags and attributes: %s' ) . '</label>', ' <code>' . allowed_tags() . '</code>')
                . '</p>';
            return $defaults;
        }
