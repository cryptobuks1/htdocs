...
<li <?php comment_class(); ?> id="li-comment-<?php comment_ID(); ?>">
    ...
    <div class="data-control-id-1200 bd-comment-1 <?php echo $comment->comment_type ?>">
        <div class="data-control-id-1086 bd-layoutcontainer-15">
 ...
 bd-row-align-top
                ...
                ">
                <div class="data-control-id-1082 
 col-md-2">
    <div class="bd-layoutcolumn-32"><div class="bd-vertical-align-wrapper"><div class="data-control-id-1074 bd-commentavatar-1">
    <?php echo theme_get_avatar(array('class' => 'data-control-id-1066 bd-imagestyles'), true);  ?>
</div></div></div>
</div>
	
		<div class="data-control-id-1084 
 col-md-22">
    <div class="bd-layoutcolumn-33"><div class="bd-vertical-align-wrapper"><div class="data-control-id-1065 bd-commentmetadata-1 comment-meta commentmetadata">
...
?>
<div class="data-control-id-1239 bd-comments-1">
	<div class="bd-container-inner">
    ...
    if (!function_exists('theme_comment_form_defaults_filter_1')){
        function theme_comment_form_defaults_filter_1($defaults) {
            ...
            $defaults['comment_notes_after'] = '<p class="form-allowed-tags">'
                . sprintf('<label class="data-control-id-190269 bd-bootstraplabel">' . __( 'You may use these <abbr title="HyperText Markup Language">HTML</abbr> tags and attributes: %s' ) . '</label>', ' <code>' . allowed_tags() . '</code>')
                . '</p>';
            return $defaults;
        }
