...
$manifest_attr = $ver !== false
    ? ' manifest="' . admin_url('admin-ajax.php', 'relative') . '?ver='.$ver.'&action=theme_get_manifest"'
    : '';

$domain_param = isset($_GET['domain']) ? '&domain='.urlencode($_GET['domain']) : '';
?>
<html<?php echo $manifest_attr; ?>>
<head>
    <meta http-equiv="X-UA-Compatible" content="IE=edge" />
    <script type="text/javascript" src="<?php echo admin_url('admin-ajax.php'); ?>?action=theme_get_project&version=<?php echo $buildTime.$domain_param; ?>"></script>
